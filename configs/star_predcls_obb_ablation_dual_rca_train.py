"""Canonical STAR PredCls architecture for the RPCM-6850 Dual/RCA base.

`pretrained/RPCM_6850_Dual_bgfirst.pth` corresponds to this dual shared-subject
/ shared-object relation graph and exact-6850 prototype route. The historical
checkpoint was trained from detector initialization; future HPRC runs load it
as a relation checkpoint rather than retraining this sampling-sensitive base.
"""
